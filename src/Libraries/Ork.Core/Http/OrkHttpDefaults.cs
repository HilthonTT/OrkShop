...
/// </summary>
public static class OrkHttpDefaults
{
    /// <summary>
    ...
    /// </summary>
    public static string IsPostBeingDoneRequestItem => "ork.IsPOSTBeingDone";
    ...
    /// </summary>
    public static string GenericRouteInternalRedirect => "ork.RedirectFromGenericPathRoute";
}
