...
namespace Ork.Core.Domain;

/// <summary>
/// Store information settings
/// </summary>
public sealed class StoreInformationSettings : ISettings
{
    /// <summary>
    ...
    /// </summary>
    public string DefaultStoreTheme { get; set; } = string.Empty;
    ...
    /// </summary>
    public string SnapchatLink { get; set; } = string.Empty;
    ...
    /// </summary>
    public string TumblrLink { get; set; } = string.Empty;
}
