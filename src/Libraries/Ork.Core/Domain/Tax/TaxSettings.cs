...
/// Tax settings
/// </summary>
public sealed class TaxSettings : ISettings
{
    /// <summary>
    /// Tax based on
    /// </summary>
    ...
    /// </summary>
    public string ActiveTaxProviderSystemName { get; set; } = string.Empty;
    ...
    /// </summary>
    public string HmrcApiUrl { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the HMRC API client id
    /// </summary>
    public string HmrcClientId { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the HMRC API client secret
    /// </summary>
    public string HmrcClientSecret { get; set; } = string.Empty;
}
