...
public sealed class CatalogSettings : ISettings
{
    /// <summary>
    ...
    /// </summary>
    public string NewProductsPageSizeOptions { get; set; } = string.Empty;
    ...
    /// </summary>
    public string SearchPagePageSizeOptions { get; set; } = string.Empty;
    ...
    /// </summary>
    public string ProductsByTagPageSizeOptions { get; set; } = string.Empty;
    ...
    /// </summary>
    public string DefaultCategoryPageSizeOptions { get; set; } = string.Empty;
    ...
    /// </summary>
    public string DefaultManufacturerPageSizeOptions { get; set; } = string.Empty;
    ...
    /// </summary>
    public string ActiveSearchProviderSystemName { get; set; } = string.Empty;
