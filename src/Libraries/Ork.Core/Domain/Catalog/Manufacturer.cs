...
public sealed class Manufacturer
    ...
    IDiscountSupported<DiscountManufacturerMapping>, 
    ISoftDeletedEntity, 
    IMetaTagsSupported
{
    /// <summary>
    ...
    /// </summary>
    public string ResponsiblePersonPhysicalAddress { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the responsible person electronic address
    /// </summary>
    public string ResponsiblePersonElectronicAddress { get; set; } = string.Empty;
}
