...
public sealed class Customer : BaseEntity, ISoftDeletedEntity
{
    /// <summary>
    /// Gets or sets the customer GUID
    /// </summary>
    public Guid CustomerGuid { get; set; } = Guid.CreateVersion7();
    ...
    /// </summary>
    public string CustomCustomerAttributesXML { get; set; } = string.Empty;
    ...
    /// </summary>
    public string EmailToRevalidate { get; set; } = string.Empty;
