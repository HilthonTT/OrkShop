...
/// Customer settings
/// </summary>
public sealed class CustomerSettings : ISettings
{
    /// <summary>
    ...
    /// </summary>
    public string UsernameValidationRule { get; set; } = string.Empty;
    ...
    /// </summary>
    public string PhoneNumberValidationRule { get; set; } = string.Empty;
    ...
    /// </summary>
    public string HashedPasswordFormat { get; set; } = string.Empty;
