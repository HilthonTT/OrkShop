...
/// CAPTCHA settings
/// </summary>
public sealed class CaptchaSettings : ISettings
{
    /// <summary>
    /// Is CAPTCHA enabled?
    /// </summary>
    ...
    /// </summary>
    public string ReCaptchaApiUrl { get; set; } = string.Empty;
    /// <summary>
    ...
    /// reCAPTCHA theme
    /// </summary>
    public string ReCaptchaTheme { get; set; } = string.Empty;
    ...
    /// </summary>
    public string ReCaptchaDefaultLanguage { get; set; } = string.Empty;
