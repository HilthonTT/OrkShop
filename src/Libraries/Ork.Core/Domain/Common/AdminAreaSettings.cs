...
public sealed class AdminAreaSettings : ISettings
{
    /// <summary>
    ...
    /// </summary>
    public string GridPageSizes { get; set; } = string.Empty;

    /// <summary>
    /// Additional settings for rich editor
    /// </summary>
    public string RichEditorAdditionalSettings { get; set; } = string.Empty;
    ...
    /// </summary>
    public string LastNewsTitleAdminArea { get; set; } = string.Empty;
