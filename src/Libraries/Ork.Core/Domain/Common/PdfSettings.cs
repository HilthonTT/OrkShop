...
/// PDF settings
/// </summary>
public sealed class PdfSettings : ISettings
{
    /// <summary>
    ...
    /// </summary>
    public string LtrFontName { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the font name that will be used
    /// </summary>
    public string RtlFontName { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the text that will appear at the bottom of invoices (column 1)
    /// </summary>
    public string InvoiceFooterTextColumn1 { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the text that will appear at the bottom of invoices (column 1)
    /// </summary>
    public string InvoiceFooterTextColumn2 { get; set; } = string.Empty;
