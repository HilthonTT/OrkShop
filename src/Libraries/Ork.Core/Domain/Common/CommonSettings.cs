...
public sealed class CommonSettings : ISettings
{
    /// <summary>
    ...
    /// </summary>
    public string BreadcrumbDelimiter { get; set; } = string.Empty;
    ...
    /// </summary>
    public string FaviconAndAppIconsHeadCode { get; set; } = string.Empty;
    ...
    /// </summary>
    public string HeaderCustomHtml { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets a value of footer custom HTML
    /// </summary>
    public string FooterCustomHtml { get; set; } = string.Empty;
}
